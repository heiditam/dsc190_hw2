...
# We to modify the observed counts to have a 0 to account for the missing grade of D.
observed_counts <- c(0, 8, 52, 31)
chi_squared_test <- chisq.test(observed_counts, p = c(0.1, 0.4, 0.3, 0.2))
```

With a p-value of 1.629 * 10^(-13), we can reject the null hypothesis. There is a difference in the proportion of grades in the target distribution and the true outcome. 
...
With our new chi-squared test, we still have a p-value of 1.629 * 10^(-13), we can reject the null hypothesis. There is a difference in the proportion of grades in the target distribution and the true outcome, and the non-respondents do not change the picture of the grade distribution.
